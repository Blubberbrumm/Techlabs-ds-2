...
data = pd.DataFrame({
    'Diabetes': data['DIABETE3'],   # Target variable
    'BMI': data['_BMI5'],           # BMI variable
    'Education': data['EDUCA'],     # Education variable
    'Is_Smoker': data['_RFSMOK3']   # Smoking status variable
})
...
#visualizing relationship between features and target using boxplots
